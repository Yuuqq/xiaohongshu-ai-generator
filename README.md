...
工具支持多种视觉风格，以下是常见主题的**预期效果**（实际生成效果更加精美细腻）：

### 科技 / AI 主题
- **色调**：蓝紫渐变 + 科技线条、节点装饰
- **适合内容**：AI、科技产品、效率工具、未来趋势类笔记
- **视觉特点**：现代、专业、简洁大气，带有轻微几何与科技感元素

### 好物 / 种草主题
- **色调**：粉色系、柔和暖色、甜美风格
- **适合内容**：美妆护肤、穿搭、好物推荐、种草笔记
- **视觉特点**：可爱温馨、视觉吸引力强，装饰元素丰富且精致

### 教程 / 步骤主题
- **色调**：清新绿色、橙色系或简约黑白
- **适合内容**：教程干货、步骤指南、知识分享、方法类笔记
- **视觉特点**：结构清晰、易于阅读，编号与层级分明

> **强大自定义能力**：支持调整装饰强度、纹理风格、颜色倾向，可为同一内容生成多张不同视觉变体，方便进行 A/B 测试。
